...
Encodes and decodes a binary sequence of a character using a parity bit. Encode
function adds the parity bit. The decode function takes away the parity bit
and returns the original character(s) that was(were) entered into the encode funtion.
The main function calls both functions when the program is run. 
